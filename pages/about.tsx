...
const About = () => {
    return(
        <div className=" text-center text-xl">
            ...
            <h3>Sources</h3> 
            <p> &emsp; Books are gathered from several different sources. PDF&apos;s and some EPUB&apos;s are taken from Google, with some PDF&apos;s taken from other educational sites. 
            Webpages are from <a href="https://www.gutenberg.org">Project Gutenberg</a>. EPUB and AZW3 formats are mainly taken from <a href="https://www.standardebooks.org">Standard Ebooks</a>. 
            </p>            
