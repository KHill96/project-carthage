        ...
        <div>
            <h3>About the Public Repository</h3> 
             ...
             <p> &emsp; Books are gatherede from several different sources. PDF`&apos;` and some EPUB`&apos;`s are taken from Google, with some PDF`&apos;`s taken from other educational sites. 
                Webpages are from the great people at <a href="www.gutenberg.org">Project Gutenberg</a>. EPUB and AZW3 formats are mainly taken from the minds behind <a>Standard Ebooks</a> </p>
            ...
            <b>The site follows US Copyright Law and it`&apos;` definition of work public domain.</b></p>
        </div>
    );
}
